  ...
  return (
    ...
    >
      ...
      <footer className="customer-company-footer">
        ...
        <a href="/terms" className="customer-terms-link">
          Условия сервиса
        </a>
      </footer>
...
function TermsPage() {
  ...
  return (
    <div className="festo-terms-page">
      <header className="festo-terms-header">
        <div className="festo-terms-brand">
          <div className="festo-terms-logo">F</div>

          <div>
            <div className="festo-terms-eyebrow">FESTO</div>
        ...
        >
          <Icon
            ...
            size={18}
            strokeWidth={2}
            className="festo-terms-back-icon"
          />
          <span>Назад в меню</span>
        </button>
      </header>

      <main className="festo-terms-main">
        <article className="festo-terms-card">
          <div className="customer-eyebrow">
            FESTO · УСЛОВИЯ СЕРВИСА
          </div>

          <h1>Условия использования FESTO</h1>

          <p className="festo-terms-lead">
            Настоящие условия регулируют использование программного
            обеспечения FESTO и связанных с ним сервисов автоматизации
            ресторанов.
          </p>
          ...
          <section>
            ...
            <p>
              Настоящее лицензионное соглашение регулирует предоставление
              права использования программного обеспечения FESTO для
              автоматизации работы ресторана. Лицензиаром по настоящему
              соглашению является ООО «Фесто», а Лицензиатом — юридическое
              лицо или индивидуальный предприниматель, указанный в учетной
              записи ресторана.
            </p>
          </section>

          <section>
            <h2>2. Предмет лицензии</h2>
            <p>
              Лицензиар предоставляет Лицензиату неисключительное,
              непередаваемое право использовать FESTO для управления меню,
              QR-меню, столами, заказами, отчетностью, настройками ресторана
              и иными доступными в аккаунте функциями. Передача исходного
              кода, перепродажа программы или предоставление доступа третьим
              лицам вне согласованного круга пользователей не разрешаются.
            </p>
          </section>

          <section>
            <h2>3. Учетная запись и безопасность</h2>
            <p>
              Лицензиат обязан хранить логин и пароль в тайне, своевременно
              обновлять данные и незамедлительно сообщать об утрате контроля
              над учетной записью. Действия, совершенные с использованием
              учетной записи, считаются совершенными Лицензиатом до момента
              уведомления Лицензиара об ее компрометации.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              При первичном подключении предоставляется пробный доступ
              продолжительностью 5 часов с момента первого входа. В течение
              пробного периода функциональность предоставляется для
              ознакомления. По окончании пробного периода доступ к кабинету
              может быть ограничен до подтверждения оплаты лицензии.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Стоимость подключения нового ресторана определяется счетом,
              выставленным Лицензиаром. Оплата производится банковским
              переводом по реквизитам, указанным в счете. После загрузки
              подтверждения платежа счет передается администратору FESTO
              на ручную проверку.
            </p>
          </section>

          <section>
            <h2>6. Бессрочная лицензия после подтверждения оплаты</h2>
            <p>
              После подтверждения администратором полной оплаты счета на
              подключение ресторана пробный период прекращается, а в учетной
              записи устанавливается статус бессрочной лицензии. Если платеж
              отклонен, статус лицензии не изменяется до получения и
              подтверждения корректного платежа.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Исключительные права на программное обеспечение FESTO, его
              интерфейс, код, товарные обозначения и документацию принадлежат
              соответствующим правообладателям. Настоящее соглашение не
              передает Лицензиату исключительные права на программу.
            </p>
          </section>

          <section>
            <h2>8. Данные ресторана и ответственность пользователя</h2>
            <p>
              Лицензиат самостоятельно отвечает за достоверность данных
              ресторана, меню, цен, описаний блюд, реквизитов, информации о
              столах и иных сведений, которые размещаются или обрабатываются
              через FESTO. Лицензиат также отвечает за законность содержания,
              размещаемого в сервисе, и за действия пользователей, которым
              предоставлен доступ к учетной записи.
            </p>
          </section>

          <section>
            <h2>9. Доступность и техническая поддержка</h2>
            <p>
              FESTO предоставляется как программный сервис. Лицензиар
              предпринимает разумные меры для поддержания работоспособности
              системы, однако не гарантирует абсолютную бесперебойность
              работы. Возможны технические работы, обновления, профилактика,
              временная недоступность отдельных функций и ограничения,
              связанные с внешними сервисами.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              FESTO является программным инструментом автоматизации и не
              заменяет бухгалтерский, юридический или иной профессиональный
              контроль. Лицензиат самостоятельно проверяет корректность цен,
              заказов, платежей, отчетов и других критически важных данных
              перед их использованием.
            </p>
          </section>

          <section>
            <h2>11. Срок действия и прекращение</h2>
            <p>
              Соглашение действует с момента принятия и, при подтвержденной
              оплате лицензии, без ограничения срока, если иное не
              предусмотрено применимым законодательством или отдельным
              письменным соглашением сторон. При существенном нарушении
              условий доступ может быть приостановлен после уведомления
              Лицензиата, если нарушение не устранено в разумный срок.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Изменения условий публикуются в интерфейсе FESTO или доводятся
              до Лицензиата иным доступным способом. Изменения, ухудшающие
              положение действующего Лицензиата, применяются с учетом
              требований законодательства и порядка уведомления.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Использование сервиса после ознакомления с настоящими условиями
              означает, что пользователь ознакомился с текстом соглашения,
              понял его условия и действует от имени Лицензиата либо имеет
              полномочия принять соглашение. Если пользователь не согласен с
              условиями, он должен прекратить использование сервиса.
            </p>
          </section>

          <div className="festo-terms-legal-note">
            <strong>Важно.</strong> Этот текст является рабочим шаблоном
            пользовательских условий сервиса FESTO. Перед коммерческим
            запуском его следует проверить и при необходимости адаптировать
            под реквизиты ООО «Фесто», выбранную юрисдикцию, налоговый режим,
            договорную модель и требования законодательства о персональных
            данных.
          </div>
        </article>
      </main>
